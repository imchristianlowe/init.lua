  ...
  'tpope/vim-surround',
  {
    ...
    config = function()
      require('project_nvim').setup{
        ...
        patterns = { ".git", "src", "docker-compose.yml", "package.json" },
      }
    end
  },
  ...
  },
{
  ...
  config = function()
      ...
      --   search = {
      --     my_venvs = {
      --       command = "fd python$ ~/code/lifesync/backend"
            -- }
      --     }
      --   }
      }
...
vim.keymap.set("n", "<leader>b", function() harpoon:list():add() end, {desc = "Add buffer to harpoon"})
